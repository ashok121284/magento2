...
class OrderExtension extends \Magento\Framework\Api\AbstractSimpleObject implements OrderExtensionInterface
{
     ...
     * @return string|null
     */
    public function getAkAttribute()
    {
        return $this->_get('ak_attribute');
    }

    /**
     * @param string $akAttribute
     * @return $this
     */
    public function setAkAttribute($akAttribute)
    {
        $this->setData('ak_attribute', $akAttribute);
        return $this;
    }
}
